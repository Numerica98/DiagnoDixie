...
class Question9 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageCharacter = findViewById(R.id.character_9)
        ...
        val play = findViewById(R.id.btn_play_9) as ImageView
        play.setOnClickListener {
            val mp = MediaPlayer.create(this, R.raw.pra)
            mp.start()
        }
        ...
        bt_Question9.setOnClickListener {
            ...
            else if(touchTextView5 % 2 != 0) //Que solo uno de los tres este seleccionado
            {
