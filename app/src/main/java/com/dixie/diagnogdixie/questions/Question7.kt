...
class Question7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageCharacter = findViewById(R.id.character_7)
        ...
        val play = findViewById(R.id.btn_play_7) as ImageView
        ...
        //Variables de id
        val textView1 = findViewById<TextView>(R.id.tv_question7_bra_0_0)
        val textView2 = findViewById<TextView>(R.id.tv_question7_dra_0_1)
        val textView3 = findViewById<TextView>(R.id.tv_question7_pra_1_0)
        val textView4 = findViewById<TextView>(R.id.tv_question7_dar_1_1)
        val textView5 = findViewById<TextView>(R.id.tv_question7_tra_2_0)
        val textView6 = findViewById<TextView>(R.id.tv_question7_bra_2_1)

        //Variable para generar el intent mas adelante
        val intentQuestion8 = Intent(this@Question7, Question8::class.java)
        ...
        bt_Question7.setOnClickListener {
            ...
            else if(touchTextView2 % 2 != 0) //Que solo uno de los tres este seleccionado
            {
                //Aumenta el puntaje del nino
                AppConstants.score = AppConstants.score +1

                //Realiza el intent para ir a la segunda pregunta
                startActivity(intentQuestion8)
