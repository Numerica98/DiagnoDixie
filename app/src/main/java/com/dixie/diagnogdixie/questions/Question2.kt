...
class Question2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageCharacter = findViewById(R.id.character_2)
        ...
        val play = findViewById(R.id.btn_play_2) as ImageView
        ...
        bt_Question2.setOnClickListener {
            ...
            else if((touchTextView2 % 2 != 0 || touchTextView3 % 2 != 0) //Que solo uno de los tres este seleccionado
                    ||
                    (touchTextView2 % 2 != 0 && touchTextView3 % 2 != 0) //Que todos los items correctos esten seleccionados
            ){
