...
class Question5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageCharacter = findViewById(R.id.character_5)
        ...
        if(AppConstants.characterKid == AppConstants.cat){
            ...
            mpNeko.start()
            Toast.makeText(this, getString(R.string.motivation1), Toast.LENGTH_LONG).show()
        ...
        val play = findViewById(R.id.btn_play_5) as ImageView
        ...
        bt_Question5.setOnClickListener {
            ...
            else if((touchTextView2 % 2 != 0 || touchTextView3 % 2 != 0 || touchTextView5 % 2 != 0) //Que solo uno de los tres este seleccionado
                    ||
